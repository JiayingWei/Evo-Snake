...
class screen(object):
    ...
    def minimize_screen(self):
        ...
        menu_options = pygame.image.load("images/start_full_quit.png").convert()
        menu_options_size = check_size("images/start_full_quit.png")
        blit_menu_options = center_object(600, 400, menu_options_size[0], menu_options_size[1])     #the centering mechanism is hard coded in (should fix)
